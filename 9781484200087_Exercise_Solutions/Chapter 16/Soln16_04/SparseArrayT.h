// Exercise 16.4 SparseArrayT.h
// SparseArray class template definition
/*
The insert() member inserts a new element following the last element.
This is used in the exercise to add elements to an element of a SparseArray that is a SparseArray.
*/
